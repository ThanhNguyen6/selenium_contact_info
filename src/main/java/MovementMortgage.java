...
public class MovementMortgage {
    ...
    @Test(testName = "Movement Mortgage")
    public void getHomeDepot() throws InterruptedException {
        driver.get("https://movement.com/search/");
        ...
        for (char alphabet = 'A'; alphabet <='Z'; alphabet ++ ) {
            WebElement searchBox = driver.findElement(By.id("search-box")).findElement(By.className("facetwp-search"));
            searchBox.clear();
            ...
            while (true) {
                try {
                    ...
                    List<WebElement> elements = driver.findElements(By.className("lo-info-container"));
                    pw = new FileWriter("movement-mortgage.csv", true);
